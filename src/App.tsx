  ...
  return (
    <main className="app-shell">
      <section className="hero" aria-labelledby="page-title">
        <h1 id="page-title">Research Workspace</h1>
        <p>
          Upload supporting documents and submit a focused research request. Results appear
          below as a streamed Markdown response.
        </p>
      </section>
      ...
      <section className="panel" aria-labelledby="sources-heading">
        ...
        <form className="form-stack" onSubmit={handleUploadSubmit}>
          ...
          />
          <p className="scope-note">Text, Markdown, and digital PDFs. Scanned image PDFs are rejected.</p>
      ...
      <section className="panel" aria-labelledby="request-heading">
        ...
        <form className="form-stack" onSubmit={handleResearchSubmit}>
          <label htmlFor="research-request">What would you like to investigate?</label>
          <textarea
            id="research-request"
            ...
            placeholder="Enter a question or research objective..."
          />
          <div className="button-row">
      ...
      <section className="panel" aria-labelledby="response-heading">
        <h2 id="response-heading">Research result</h2>
        <pre className="markdown-output" aria-live="polite">
          {markdown || 'Your research result will appear here.'}
        </pre>
      </section>
    </main>
  )
